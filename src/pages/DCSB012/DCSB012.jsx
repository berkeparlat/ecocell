...
const DCSB012 = () => {
  ...
  useEffect(() => {
    const iframe = document.querySelector('.dcs-b012-panel iframe');
    if (iframe && zoom !== 100) {
  ...
  const loadLatestFile = async () => {
    setLoading(true);
    try {
      const file = await getLatestExcelFile('dcs-b012');
      if (file) {
        setExcelData(file);
      }
    } catch (error) {
  ...
  return (
    <div className="dcs-b012-page">
      <SimpleHeader />
      
      <div className="dcs-b012-container">
        {loading ? (
          ...
          <div className="dcs-b012-single-view">
            <div className="dcs-b012-panel">
              <div className="panel-header">
                <div className="panel-header-left">
                  <Activity size={20} />
                  <h2>DCS Haftalık Rapor B Hattı - B012 Bölgesi</h2>
                </div>
                {excelData && (
