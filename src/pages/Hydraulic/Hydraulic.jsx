...
import { RefreshCw, Droplet, ZoomIn, ZoomOut, RotateCcw, Maximize2 } from 'lucide-react';
...
const Hydraulic = () => {
  ...
  useEffect(() => {
    const applyZoom = () => {
      const iframe = document.querySelector('.hydraulic-panel iframe');
      if (iframe) {
    ...
    <div className="hydraulic-page">
      ...
      <div className="hydraulic-container">
        {loading ? (
          ...
          <div className="hydraulic-single-view">
            <div className="hydraulic-panel">
              <div className="panel-header">
                <div className="panel-header-left">
                  <Droplet size={20} />
                  <h2>Hidrolik Tüketimi</h2>
                </div>
                {excelData && (
