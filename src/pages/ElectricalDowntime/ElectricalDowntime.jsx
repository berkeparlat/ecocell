...
import './ElectricalDowntime.css';

const ElectricalDowntime = () => {
  ...
  useEffect(() => {
    const iframe = document.querySelector('.electrical-downtime-panel iframe');
    if (iframe && zoom !== 100) {
  ...
  const loadLatestFile = async () => {
    setLoading(true);
    try {
      const file = await getLatestExcelFile('electrical-downtime');
      if (file) {
        setExcelData(file);
      }
    } catch (error) {
  ...
  return (
    <div className="electrical-downtime-page">
      <SimpleHeader />
      
      <div className="electrical-downtime-container">
        {loading ? (
          ...
          <div className="electrical-downtime-single-view">
            <div className="electrical-downtime-panel">
              <div className="panel-header">
                <div className="panel-header-left">
                  <Zap size={20} />
                  <h2>Elektrik Bakım Duruş İş Listesi</h2>
                </div>
                {excelData && (
...
export default ElectricalDowntime;
