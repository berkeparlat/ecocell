...
import { Upload, Download, RefreshCw, Calendar, FileSpreadsheet, Trash2, Lock } from 'lucide-react';
...
const DailyStock = () => {
  ...
  const loadAllFiles = async () => {
    try {
      const files = await listAllExcelFiles('stock');
      setAllFiles(files);
    } catch (error) {
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      await uploadExcelFile(selectedFile, 'stock');
        ...
        {isUserAdmin && (
          <div className="upload-section">
            <div className="upload-card">
              ...
              <p>Güncellenmiş stok dosyanızı buradan yükleyebilirsiniz</p>
            ...
            <div className="history-list">
              {allFiles.map((file, index) => (
                <div key={index} className="history-item">
                  ...
                  </div>                  <div className="history-actions">
                    <button
