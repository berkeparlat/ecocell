...
const DCSBuhar = () => {
  ...
  useEffect(() => {
    const applyZoom = () => {
      const iframe = document.querySelector('.dcs-buhar-panel iframe');
      if (iframe) {
  ...
  return (
    <div className="dcs-buhar-page">
      <SimpleHeader />
      
      <div className="dcs-buhar-container">
        {loading ? (
          ...
          <div className="dcs-buhar-single-view">
            <div className="dcs-buhar-panel">
