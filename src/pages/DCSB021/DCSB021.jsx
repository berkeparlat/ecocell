...
const DCSB021 = () => {
  ...
  useEffect(() => {
    const iframe = document.querySelector('.dcs-b021-panel iframe');
    if (iframe && zoom !== 100) {
  ...
  const loadLatestFile = async () => {
    setLoading(true);
    try {
      const file = await getLatestExcelFile('dcs-b021');
      if (file) {
        setExcelData(file);
      }
    } catch (error) {
  ...
  return (
    <div className="dcs-b021-page">
      <SimpleHeader />
      
      <div className="dcs-b021-container">
        {loading ? (
          ...
          <div className="dcs-b021-single-view">
            <div className="dcs-b021-panel">
              <div className="panel-header">
                <div className="panel-header-left">
                  <Activity size={20} />
                  <h2>DCS Haftalık Rapor B Hattı - B021 Bölgesi</h2>
                </div>
                {excelData && (
